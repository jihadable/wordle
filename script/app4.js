...
let guessWord;
let random = Math.floor(Math.random()*(guessWords4.length) + 0)
...
for (let i = 0 ; i < 4 ; i++){
    guessWord[i] = guessWords4[random].slice(i,i+1)
            ...
            setTimeout(() => {
                ...
                for (let j = 0 ; j < 4 ; j++){
                    if (guess[j] == guessWord[j]){
                        if (row != 0){
                            setTimeout(() => {
                                words[i + j - 4].style.backgroundColor = "lime"
                                
                                let same = words[i + j - 4].innerHTML
                        ...
                        for (let k = 0 ; k < 4 ; k++){
                            if (guess[j] == guessWord[k] && j != k){
                                if (row != 0){
                                    setTimeout(() => {
                                        words[i + j - 4].style.backgroundColor = "#fad02c"
                                    ...
                                    setTimeout(() => {
                                        ...
                                        for (let k = 0 ; k < keys.length ; k++){
                                            if (keys[k].innerHTML == same && !keys[k].classList.contains("green") && !keys[k].classList.contains("yellow")){
                                                words[i + j - 4].style.backgroundColor = "#dee"
